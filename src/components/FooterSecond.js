...
function FooterSecond() {
    ...
    const [Mor1, setMore]=useState(false);
    ...
    return (
        <div className="bg1">
            ...
            {Mor1?(<NavLinks heading="WE DELIVER TO" showHeading={true}  links={column1City.concat(column1City)} ></NavLinks>):(<NavLinks heading="WE DELIVER TO" showHeading={true}  links={column1City} ></NavLinks>)}

            {Mor1?<NavLinks showHeading={false} links={column2City.concat(column2City)} ></NavLinks>:<NavLinks showHeading={false} links={column2City} ></NavLinks>}
            {Mor1?<NavLinks showHeading={false} links={column3City.concat(column3City)} ></NavLinks>:<NavLinks showHeading={false} links={column3City} ></NavLinks>}
            {Mor1?<NavLinks showHeading={false} links={column4City.concat(column4City)} ></NavLinks>:<NavLinks showHeading={false} links={column4City} ></NavLinks>}
            
            </div>
            <div className="see" style={{textAlign:'center',color:'gray',marginTop:'15px',cursor:'grab'}}>

        {Mor1?(<p style={{fontWeight:'bold'}}  onClick={changeStateFalse} className="see" >See Less....  <i className="fa fa-minus-circle" aria-hidden="true"  ></i></p>):(<p  style={{fontWeight:'bold'}}  onClick={changeStateTrue} className="see">See More....  <i className="fa fa-plus-circle" aria-hidden="true"  ></i></p>)}
